...
<img src="/hoa-blog-pipeline.svg" alt="HOA Blog Automation Pipeline — 6-step flowchart from scheduler to publish" style="width:100%;border-radius:8px;margin:32px 0;" />
